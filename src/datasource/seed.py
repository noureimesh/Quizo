...
FIRST_SEEDED_QUIZ_ID = PyObjectId('666f6f2d6261722d71757578')
...
def generate_quizzes():
    ...
    question_1.options=[option_11.dict(by_alias=True),option_12.dict(by_alias=True),option_13.dict(by_alias=True),option_14.dict(by_alias=True)]
    ...
    question_2.options=[option_21.dict(by_alias=True),option_22.dict(by_alias=True),option_23.dict(by_alias=True),option_24.dict(by_alias=True)]
    ...
    question_3.options=[option_31.dict(by_alias=True), option_32.dict(by_alias=True),option_33.dict(by_alias=True),option_34.dict(by_alias=True)]
    ...
    question_11.options=[option_111.dict(by_alias=True),option_122.dict(by_alias=True),option_133.dict(by_alias=True),option_144.dict(by_alias=True)]
    ...
    question_22.options=[option_211.dict(by_alias=True),option_222.dict(by_alias=True),option_233.dict(by_alias=True),option_244.dict(by_alias=True)]
    ...
    question_33.options=[option_311.dict(by_alias=True),option_322.dict(by_alias=True),option_333.dict(by_alias=True),option_344.dict(by_alias=True)]
